...
public final class TickParser {
    ...
    private static final SimpleDateFormat SDFTwentyFour = new SimpleDateFormat("HH:mm", Locale.GERMAN);
    private static final SimpleDateFormat SDFTwelve = new SimpleDateFormat("h:mm aa", Locale.GERMAN);

    static {
        SDFTwentyFour.setTimeZone(TimeZone.getTimeZone("GMT+1"));
        SDFTwelve.setTimeZone(TimeZone.getTimeZone("GMT+1"));
    ...
    public static Date ticksToDate(long ticks) {
        ...
        final Calendar cal = Calendar.getInstance(TimeZone.getTimeZone("GMT+1"), Locale.GERMAN);
        cal.setLenient(true);
